...
import pit.raw.ComputeDate;
import pit.raw.Validate;

import java.util.Arrays;
import java.util.Collection;

@RunWith(Parameterized.class)
public class ComputeDateTest2 extends TestCase {
...
//getYearOfNextDay
    ...
    public ComputeDateTest2(int input1, int input2, int input3, int expected) {
        this.input1 = input1;
        this.input2 = input2;
        this.input3 = input3;
...
//		assertEquals(expected, computeDate.getYearOfNextDay1(input1, input2, input3));
//		assertEquals(expected, computeDate.getYearOfNextDay2(input1, input2, input3));
//		assertEquals(expected, computeDate.getYearOfNextDay3(input1, input2, input3));
//        assertEquals(expected, computeDate.getYearOfNextDay4(input1, input2, input3));
//        assertEquals(expected, computeDate.getYearOfNextDay5(input1, input2, input3));

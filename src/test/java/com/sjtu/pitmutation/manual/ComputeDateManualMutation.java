...
public class ComputeDateManualMutation {

	private Validate val;

	public ComputeDateManualMutation(Validate val) {
		setVal(val);
	}
...
//		add (  ==false)
	...
	/**
	 * getYearOfNextDay mute pit.test 1
	 * @param year
	 * @param month
	 * @param day
	 * @return
...
//		nextYear change to nextYear+1
	...
	/**
	 * getYearOfNextDay mute pit.test 2
	 * @param year
	 * @param month
	 * @param day
	 * @return
...
//		nextYear change to nextYear+1
	...
	/**
	 * getYearOfNextDay mute pit.test 3
	 * @param year
	 * @param month
	 * @param day
	 * @return
...
//		year change to year+1
	...
	/**
	 * getYearOfNextDay mute pit.test 4
	 * @param year
	 * @param month
	 * @param day
	 * @return
...
//		change year to year+2
	...
	/**
	 * getYearOfNextDay mute pit.test 5
	 * @param year
	 * @param month
	 * @param day
	 * @return

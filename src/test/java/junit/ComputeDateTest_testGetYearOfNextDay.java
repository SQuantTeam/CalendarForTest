...
public class ComputeDateTest_testGetYearOfNextDay extends TestCase{
	...
	public ComputeDateTest_testGetYearOfNextDay(int input1, int input2, int input3, int expected){  
        this.input1 = input1;  
        this.input2 = input2;
        this.input3 = input3;

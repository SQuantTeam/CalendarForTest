package com.sjtu.pitmutation.test;
...
public class ComputeDateTest_2 extends TestCase {
...
//getYearOfNextDay
    ...
    public ComputeDateTest_2(int input1, int input2, int input3, int expected) {
        this.input1 = input1;
        this.input2 = input2;
        this.input3 = input3;

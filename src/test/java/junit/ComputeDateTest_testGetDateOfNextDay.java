...
public class ComputeDateTest_testGetDateOfNextDay extends TestCase{
	...
	public ComputeDateTest_testGetDateOfNextDay(int input1, int input2, int input3, int expected){  
        this.input1 = input1;  
        this.input2 = input2;
        this.input3 = input3;
